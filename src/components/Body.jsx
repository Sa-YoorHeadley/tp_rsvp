    ...
    <div className="h-full flex flex-col items-center gap-8 py-16 px-12 bg-[#FB6376] sm:text-xl text-center">
        ...
        {data && data.response === 'Pending' && status === 200 && 
            <div>
                ...
                <button className="w-32 py-1 px-4 rounded-lg bg-white border-2 border-[#5D2A42] text-[#FB6376]" onClick={respond}>Respond</button>
            </div>
        }
        ...
        {data && data.response !== 'Pending' && status === 200 && 
            <div>
                ...
                <button className="mt-4 w-32 py-1 px-4 rounded-lg bg-white border-2 border-[#5D2A42] text-[#FB6376]" onClick={respond}>Respond</button>
            </div>
        }
